    ...
    <div class="email-container">
        ...
        <div class="header">
            ...
            <div class="status-badge {{ $receipt['payment_status'] }}">
                ✓ Payment {{ ucfirst($receipt['payment_status']) }}
            </div>
        </div>
        ...
        <div class="content">
            ...
            <div class="order-summary">
                <div class="summary-header">
                    <span class="summary-title">Order #{{ $receipt['order_number'] ?? $receipt['receipt_number'] }}</span>
        ...
        <div class="footer">
            ...
            <p>Tel: {{ $receipt['business_phone'] }}</p>
            @endif
