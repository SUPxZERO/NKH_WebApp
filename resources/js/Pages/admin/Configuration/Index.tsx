...
export default function ConfigurationIndex({ orderTypes, orderStatuses, paymentStatuses, loyaltyTiers }: PageProps) {
    ...
    const tabs = [
        { id: 'order_types', label: t('admin.system.configuration.tabs.order_types'), icon: Truck, color: 'text-blue-500' },
        { id: 'order_statuses', label: t('admin.system.configuration.tabs.order_statuses'), icon: Grid, color: 'text-orange-500' },
        { id: 'payment_statuses', label: t('admin.system.configuration.tabs.payment_statuses'), icon: CreditCard, color: 'text-green-500' },
        { id: 'loyalty_tiers', label: t('admin.system.configuration.tabs.loyalty_tiers'), icon: Award, color: 'text-purple-500' },
    ];
                ...
                >
                    <div className="flex items-center justify-between p-4 border-b border-border bg-muted/50">
                        <h3 className="text-lg font-semibold flex items-center gap-2">
                            ...
                            {t('admin.system.configuration.modal.edit_title').replace('{name}', item.name)}
                        </h3>
                    ...
                    <form onSubmit={handleSubmit} className="p-4 space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="col-span-2">
                                <label className="block text-sm font-medium mb-1">{t('admin.system.configuration.modal.fields.name')}</label>
                                <input
                                    type="text"
                                    value={data.name}
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-1">{t('admin.system.configuration.modal.fields.icon')}</label>
                                <input
                                    type="text"
                                    value={data.icon || ''}
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-1">{t('admin.system.configuration.modal.fields.color')}</label>
                            ...
                            <div>
                                <label className="block text-sm font-medium mb-1">{t('admin.system.configuration.modal.fields.display_order')}</label>
                                <input
                                    type="number"
                            ...
                            <div className="col-span-2 flex items-center gap-2">
                                <label className="relative inline-flex items-center cursor-pointer">
                                    ...
                                    <span className="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">{t('admin.system.configuration.modal.fields.active')}</span>
                                </label>
                            </div>
                            ...
                            {activeTab === 'order_types' && (
                                <div className="col-span-2 space-y-2 border-t border-border pt-4 mt-2">
                                    <h4 className="font-medium text-sm text-muted-foreground">{t('admin.system.configuration.modal.fields.capabilities')}</h4>
                                    <div className="flex gap-4">
                                        <label className="flex items-center gap-2 text-sm">
                                            ...
                                            {t('admin.system.configuration.modal.options.allows_delivery')}
                                        </label>
                                        <label className="flex items-center gap-2 text-sm">
                                            ...
                                            {t('admin.system.configuration.modal.options.allows_pickup')}
                                        </label>
                                        <label className="flex items-center gap-2 text-sm">
                                            ...
                                            {t('admin.system.configuration.modal.options.allows_table')}
                                        </label>
                                    </div>
                                </div>
                            )}
                            ...
                            {activeTab === 'order_statuses' && (
                                <div className="col-span-2 space-y-2 border-t border-border pt-4 mt-2">
                                    <h4 className="font-medium text-sm text-muted-foreground">{t('admin.system.configuration.modal.fields.workflow')}</h4>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-sm font-medium mb-1">{t('admin.system.configuration.modal.fields.workflow_pos')}</label>
                                        ...
                                        <div className="flex flex-col gap-2 pt-6">
                                            <label className="flex items-center gap-2 text-sm">
                                                ...
                                                {t('admin.system.configuration.modal.options.is_terminal')}
                                            </label>
                                            <label className="flex items-center gap-2 text-sm">
                                                ...
                                                {t('admin.system.configuration.modal.options.show_customer')}
                                            </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {activeTab === 'payment_statuses' && (
                                <div className="col-span-2 space-y-2 border-t border-border pt-4 mt-2">
                                    <h4 className="font-medium text-sm text-muted-foreground">{t('admin.system.configuration.modal.fields.attributes')}</h4>
                                    <div className="flex gap-4">
                                        <label className="flex items-center gap-2 text-sm">
                                            ...
                                            {t('admin.system.configuration.modal.options.is_successful')}
                                        </label>
                                        <label className="flex items-center gap-2 text-sm">
                                            <input type="checkbox" checked={data.is_terminal} onChange={e => setData('is_terminal', e.target.checked)} className="rounded border-input text-blue-600" />
                                            {t('admin.system.configuration.modal.options.is_terminal')}
                            ...
                            {activeTab === 'loyalty_tiers' && (
                                <div className="col-span-2 space-y-2 border-t border-border pt-4 mt-2">
                                    <h4 className="font-medium text-sm text-muted-foreground">{t('admin.system.configuration.modal.fields.rules')}</h4>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <label className="block text-sm font-medium mb-1">{t('admin.system.configuration.modal.fields.min_spent')}</label>
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium mb-1">{t('admin.system.configuration.modal.fields.max_spent')}</label>
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium mb-1">{t('admin.system.configuration.modal.fields.discount_percent')}</label>
                                        ...
                                        <div>
                                            <label className="block text-sm font-medium mb-1">{t('admin.system.configuration.modal.fields.multiplier')}</label>
                        ...
                        <div className="flex justify-end gap-2 pt-4 border-t border-border">
                            <Button type="button" variant="ghost" onClick={onClose}>{t('admin.system.configuration.modal.buttons.cancel')}</Button>
                            <Button type="submit" disabled={processing} className="bg-blue-600 hover:bg-blue-700 text-white">
                                <Save className="w-4 h-4 mr-2" /> {t('admin.system.configuration.modal.buttons.save')}
                            </Button>
                        </div>
                    </form>
                </motion.div>
    ...
    return (
        <AdminLayout>
            <Head title={t('admin.system.configuration.title')} />
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight text-foreground flex items-center gap-3">
                            ...
                            {t('admin.system.configuration.title')}
                        </h1>
                        <p className="text-muted-foreground mt-2">{t('admin.system.configuration.subtitle')}</p>
                    </div>
                </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-sm text-left">
                                <thead className="text-xs text-muted-foreground uppercase bg-muted/50">
                                    <tr>
                                        <th className="px-6 py-4">{t('admin.system.configuration.table.headers.display_order')}</th>
                                        <th className="px-6 py-4">{t('admin.system.configuration.table.headers.name_code')}</th>
                                        <th className="px-6 py-4">{t('admin.system.configuration.table.headers.visuals')}</th>
                                        <th className="px-6 py-4">{t('admin.system.configuration.table.headers.status')}</th>
                                        <th className="px-6 py-4">{t('admin.system.configuration.table.headers.attributes')}</th>
                                        <th className="px-6 py-4 text-right">{t('admin.system.configuration.table.headers.actions')}</th>
                                    </tr>
                                </thead>
