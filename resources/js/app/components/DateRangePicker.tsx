        ...
        <div className={`flex items-center gap-3 ${className}`}>
            <div className="relative">
                ...
                <DatePicker
                    ...
                    startDate={startDate}
                    endDate={endDate}
                    placeholderText={t('common.components.date_picker.start_date')}
            ...
            <span className="text-gray-400 text-sm">{t('common.components.date_picker.to')}</span>
            ...
            <div className="relative">
                ...
                <DatePicker
                    ...
                    endDate={endDate}
                    minDate={startDate}
                    placeholderText={t('common.components.date_picker.end_date')}
                    className="bg-white/5 border border-white/10 rounded-lg px-10 py-2 text-white text-sm focus:outline-none focus:ring-2 focus:ring-purple-500 w-40"
                    dateFormat="MMM d, yyyy"
                    maxDate={new Date()}
                />
